...
<div id="page-wrapper">
    <div class="container">
            ...
            <!-- /.card-heading -->
            <div class="card-body">
                <form role="form" action="edit_pass_act.php" class="col-md-12" method="post"
                    ...
                    <div class="form-group col-12">
                        <label>Passwod Baru :</label>
                        <input name="newpass" type="password" class="form-control" required>
                    </div>
                    <div class="form-group col-12">
                        <label>Konfirmasi Password :</label>
                        <input name="comfpass" type="password" class="form-control" required>
                    </div>
                    </div>
                    <hr>
